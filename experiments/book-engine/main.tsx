...
const BookAssembly = ({ currentPage, onCloseComplete }: { currentPage: number, onCloseComplete: () => void }) => {
  ...
  useFrame((state, delta) => {
    ...
    // Apply reduced-intensity dynamic mouse movement for stability
    const targetRotX = 0.25 + (interactionState.mouseY * 0.4);
    const targetRotY = -0.3 + (interactionState.mouseX * 0.5);
