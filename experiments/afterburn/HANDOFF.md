# Afterburn Tearing Experiment — Handoff

This document describes the interface and constraints for promoting the afterburn tearing prototype to production.

## What it takes in
- A sequence of afterburn image paths (currently defined in `images.ts`).
