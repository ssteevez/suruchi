# Afterburn Interaction & Physics Prototype
...
## Handoff Status
The prototype in `experiments/afterburn/` is complete, tested, and approved by the Curator. It is ready for Cursor to audit against this spec and rebuild into `src/`.
